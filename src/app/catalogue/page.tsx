      ...
      <ContactSection showForm={false}>
        ...
        <div className="grid md:grid-cols-2 gap-4">
          {categories.map((c, i) => (
            ...
            <Link
              href={c.href}
              className="group relative overflow-hidden rounded-xl bg-white widget-card-bg min-h-[220px] sm:min-h-[260px] p-6 sm:p-8 shadow-card transition-all duration-300 hover:shadow-card-hover hover:-translate-y-1"
            >
